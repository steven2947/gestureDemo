...
package com.steven.demo.base.clean.presentation.adapter.delegate.adapterdelegates2;
...
public class AdapterDelegatesManager<T> {
    ...
    public void onBindViewHolder(@NonNull T items, int position,
                                 @NonNull RecyclerView.ViewHolder viewHolder, List<Object> payloads) {
     ...
     */
    public void onBindViewHolder(@NonNull T items, int position,
                                 @NonNull RecyclerView.ViewHolder viewHolder, int viewType, List<Object> payloads) {
    ...
    public void destroy() {
        ...
        for (int i = 0; i < delegates.size(); i++) {
            ...
            AdapterDelegate adapterDelegate = delegates.get(key);
     ...
     * @return
     */
    public boolean contains(AdapterDelegate<T> adapterDelegate) {
        for (int i = 0; i < delegates.size(); i++) {
            if (delegates.get(i).getClass().equals(adapterDelegate.getClass())) {
                return true;
            }
        }
        return false;
