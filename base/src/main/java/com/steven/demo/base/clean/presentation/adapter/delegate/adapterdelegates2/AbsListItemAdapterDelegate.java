 ...
 * }
 * @Override protected void onBindBaseViewHolder(Cat item, CatViewHolder viewHolder);
...
public abstract class AbsListItemAdapterDelegate<I extends T, T, VH extends RecyclerView.ViewHolder>
     ...
     */
    protected abstract void onBindViewHolder(@NonNull I item, @NonNull VH viewHolder, List<Object> payloads);
}
